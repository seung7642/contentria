...
import com.demo.blog.auth.dto.RecaptchaResponse
import com.demo.blog.auth.dto.RecaptchaVerificationResult
import com.demo.blog.auth.dto.RecaptchaVerifyRequest
...
class RecaptchaServiceImpl(
    ...
    override fun verifyRecaptchaV3(
        token: String?,
        clientIp: String?,
        action: String?
    ...
    override fun verifyRecaptchaV2(token: String?, clientIp: String?): Mono<RecaptchaVerificationResult> {
        if (token.isNullOrBlank()) {
        ...
        if (recaptchaProperties.v2SecretKey.isNullOrBlank()) {
