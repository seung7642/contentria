...
import com.demo.blog.common.exception.MissingRecaptchaTokenException
import com.demo.blog.common.exception.RecaptchaVerificationFailedException
...
class SignUpServiceImpl(
    ...
    override fun initiate(request: SignUpInitiateRequest, httpRequest: HttpServletRequest): SignUpInitiateResponse {
        ...
        // TODO: rate limiting 로직 추가 (예: IP당 1시간에 5회 제한)

        // TODO: 기본 유효성 검사 (예: 이메일 형식, 이메일 계정 존재 유무, 비밀번호 강도)
