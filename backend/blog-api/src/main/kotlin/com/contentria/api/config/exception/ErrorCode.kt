...
enum class ErrorCode(
    ...
    RECAPTCHA_VERIFICATION_FAILED(HttpStatus.BAD_REQUEST, "C0005", "reCAPTCHA verification failed. Please try again."),
    RECAPTCHA_ACTION_MISMATCH(HttpStatus.BAD_REQUEST, "C0006", "reCAPTCHA action mismatch."),
    ...
    // Auth
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "AU0000", "Access denied: Invalid or expired token"),
    ...
    UNEXPECTED_AUTHENTICATION_PRINCIPAL(HttpStatus.INTERNAL_SERVER_ERROR, "AU0009", "Could not resolve user details from the current authentication session."),
}