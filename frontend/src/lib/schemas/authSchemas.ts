...
export const loginEmailStepSchema = z.object({
  email: z
    .string()
    .min(1, { message: 'Please enter your email address.' })
    .email({ message: 'Please enter a valid email address.' }),
...
export type SignUpEmailStepFormData = z.infer<typeof signUpEmailStepSchema>;
export type LoginEmailStepFormData = z.infer<typeof loginEmailStepSchema>;
